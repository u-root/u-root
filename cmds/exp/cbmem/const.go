...
const (
	CFR_TAG_FORM          = 0x01
	CFR_TAG_ENUM_VALUE    = 0x02
	CFR_TAG_OPTION_ENUM   = 0x03
	CFR_TAG_OPTION_NUMBER = 0x04
	CFR_TAG_OPTION_BOOL   = 0x05
	CFR_TAG_OPTION_STRING = 0x06
	CFR_TAG_OPT_NAME      = 0x07
	CFR_TAG_PROMPT        = 0x08
	CFR_TAG_HELP          = 0x09
	CFR_TAG_DEFAULT       = 0x0A
	CFR_TAG_COMMENT       = 0x0B
	CFR_TAG_PROMPT_VALUE  = 0x0C
	CFR_TAG_DEFAULT_VALUE = 0x0D

	CFR_TAG_DEFAULT_VISIBLE = 0x0E
	CFR_TAG_PROMPT_VISIBLE  = 0x0F
)

const (
	CFR_EXPR_TYPE_CONST_BOOL   = 0x00
	CFR_EXPR_TYPE_CONST_UINT64 = 0x01
	CFR_EXPR_TYPE_CONST_STRING = 0x02
	CFR_EXPR_TYPE_SYMBOL       = 0x03
	CFR_EXPR_TYPE_NOT          = 0x04
	CFR_EXPR_TYPE_OR           = 0x05
	CFR_EXPR_TYPE_AND          = 0x06
	CFR_EXPR_TYPE_EQUAL        = 0x07
)
...
var (
	...
	tagNames     = map[uint32]string{
		...
		LB_TAG_ACPI_CNVS:             "LB_TAG_ACPI_CNVS",
		LB_TAG_TYPE_C_INFO:           "LB_TAG_TYPE_C_INFO",
		LB_TAG_ACPI_RSDP:             "LB_TAG_ACPI_RSDP",
		LB_TAG_PCIE:                  "LB_TAG_PCIE",
		LB_TAG_CFR:                   "LB_TAG_CFR",
