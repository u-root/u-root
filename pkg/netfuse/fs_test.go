...
func TestFileFS(t *testing.T) { RunTests(t) }
...
type fileFSTest struct {
	samples.SampleTest
}

func (t *fileFSTest) SetUp(ti *TestInfo) {
	tempDir, err := ioutil.TempDir("", "netfuse")
	if err != nil {
		panic("fix this")
	}
	t.Server = netfuse.New(tempDir)
	// Make this true to get more debugging than you can stand.
	if false {
...
func init() {
	...
	RegisterTestSuite(&FileFSTest{})
}

func (t *FileFSTest) ContentsOfEmptyFileSystem() {
...
func (t *FileFSTest) Mkdir_OneLevel() {
	var err error
	var fi os.FileInfo
...
func (t *FileFSTest) Mkdir_TwoLevels() {
	var err error
	var fi os.FileInfo
	...
	// This is too fs and system-dependent. ExpectEq(0, stat.Size)
...
func (t *FileFSTest) Mkdir_Many() {
	...
	var names []string
	for i := 0; i < 1001/1; i++ {
		names = append(names, filepath.Join(t.Dir, "parent", fmt.Sprintf("%d", i)))
	}
	...
	log.Printf("Created %d kids", len(names))
	...
	log.Printf("Stat'ed %d kids", len(names))
	// Read the parent.
	log.Printf("Read the parent")
	entries, err = fusetesting.ReadDirPicky(path.Join(t.Dir, "parent"))
...
func (t *FileFSTest) Mkdir_AlreadyExists() {
	var err error
	dirName := path.Join(t.Dir, "dir")
...
func (t *FileFSTest) Mkdir_IntermediateIsFile() {
	var err error
...
func (t *FileFSTest) Mkdir_IntermediateIsNonExistent() {
	var err error
...
func (t *FileFSTest) Mkdir_PermissionDenied() {
	var err error
...
func (t *FileFSTest) CreateNewFile_InRoot() {
	var err error
	var fi os.FileInfo
	var stat *syscall.Stat_t
...
func (t *FileFSTest) CreateNewFile_InSubDir() {
	var err error
	var fi os.FileInfo
	var stat *syscall.Stat_t
...
func (t *FileFSTest) ModifyExistingFile_InRoot() {
	var err error
	var n int
	var fi os.FileInfo
	var stat *syscall.Stat_t
...
func (t *FileFSTest) ModifyExistingFile_InSubDir() {
	var err error
	var n int
	var fi os.FileInfo
	var stat *syscall.Stat_t
...
func (t *FileFSTest) UnlinkFile_Exists() {
	var err error
...
func (t *FileFSTest) UnlinkFile_NonExistent() {
...
func (t *nFileFSTest) UnlinkFile_StillOpen() {
	fileName := path.Join(t.Dir, "foo")
...
func (t *FileFSTest) Rmdir_NonEmpty() {
	var err error
...
func (t *FileFSTest) Rmdir_NonExistent() {
...
func (t *nFileFSTest) Rmdir_OpenedForReading() {
	var err error
...
func (t *FileFSTest) CaseSensitive() {
	var err error
...
func (t *FileFSTest) WriteOverlapsEndOfFile() {
	var err error
	var n int
...
func (t *FileFSTest) WriteStartsAtEndOfFile() {
	var err error
	var n int
...
func (t *FileFSTest) WriteStartsPastEndOfFile() {
	var err error
	var n int
...
func (t *FileFSTest) WriteAtDoesntChangeOffset_NotAppendMode() {
	var err error
	var n int
...
func (t *FileFSTest) WriteAtDoesntChangeOffset_AppendMode() {
	var err error
	var n int
...
func (t *FileFSTest) ReadsPastEndOfFile() {
	var err error
	var n int
	buf := make([]byte, 1024)
...
func (t *FileFSTest) Truncate_Smaller() {
	var err error
	fileName := path.Join(t.Dir, "foo")
...
func (t *FileFSTest) Truncate_SameSize() {
	var err error
	fileName := path.Join(t.Dir, "foo")
...
func (t *FileFSTest) Truncate_Larger() {
	var err error
	fileName := path.Join(t.Dir, "foo")
...
func (t *nFileFSTest) ReadDirWhileModifying() {
	dirName := path.Join(t.Dir, "dir")
...
func (t *FileFSTest) CreateSymlink() {
	var fi os.FileInfo
	var err error
...
func (t *FileFSTest) CreateSymlink_AlreadyExists() {
	var err error
...
func (t *FileFSTest) ReadLink_NonExistent() {
	_, err := os.Readlink(path.Join(t.Dir, "foo"))
	ExpectTrue(os.IsNotExist(err), "err: %v", err)
}

func (t *FileFSTest) ReadLink_NotASymlink() {
	var err error
...
func (t *FileFSTest) DeleteSymlink() {
	var err error
...
func (t *FileFSTest) CreateHardlink() {
	var fi os.FileInfo
	var err error
...
func (t *FileFSTest) CreateHardlink_AlreadyExists() {
	var err error
...
// It's a one way trip.
func (t *nFileFSTest) DeleteHardlink() {
	var fi os.FileInfo
	var err error
...
func (t *nFileFSTest) ReadHardlink() {
	var err error
...
func (t *nFileFSTest) RenameWithinDir_Directory() {
	var err error
...
func (t *nFileFSTest) RenameWithinDir_SameName() {
	var err error
...
func (t *nFileFSTest) RenameAcrossDirs_File() {
	var err error
...
func (t *nFileFSTest) RenameAcrossDirs_Directory() {
	var err error
...
func (t *nFileFSTest) RenameOutOfFileSystem() {
	var err error
...
func (t *FileFSTest) RenameIntoFileSystem() {
	var err error
...
func (t *FileFSTest) RenameOverExistingFile() {
	var err error
...
func (t *FileFSTest) RenameOverExistingDirectory() {
	var err error
...
func (t *nFileFSTest) RenameOverExisting_WrongType() {
	var err error
...
func (t *FileFSTest) RenameNonExistentFile() {
	var err error
