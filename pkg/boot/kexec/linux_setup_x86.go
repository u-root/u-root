...
func SetupLinuxBootloaderParameters(lph *bzimage.LinuxParams, kmem *Memory, ramfs io.ReaderAt, cmdLineOffset, setupBase uint, cmdline string) error {
...
func SetupLinuxSystemParameters(lph *bzimage.LinuxParams) error {
