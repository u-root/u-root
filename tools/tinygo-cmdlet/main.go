...
import (
	...
	"github.com/u-root/u-root/tools/tinygo-cmdlet/pkg/builder"
)
...
func reportGH(r report) error {
	...
	// preamble
	s.WriteString(fmt.Sprintf(reportPreamble, r.TotalCmdlets, r.Success, r.Failed, r.SuccessRate, "", "", ""))
...
func (cmd *cmd) run() error {
	...
	b, err := builder.NewBuilder(BuildWorkerCount)
	if err != nil {
		return err
	}
