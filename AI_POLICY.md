...
> [Delve projects's AI_POLICY.md](https://github.com/go-delve/delve/blob/master/Documentation/AI/AI_POLICY.md) which was adapted from the
> [Ghostty project's AI_POLICY.md](https://github.com/ghostty-org/ghostty/blob/main/AI_POLICY.md).
> We are grateful to the Delve and Ghostty maintainers for providing a clear and
...
- **All AI usage in any form must be disclosed.** You must state
  ...
  the extent that the work was AI-assisted. AI tools or models shall not be added as Co-authored-by tags but rather disclosed in free-form.
...
These rules apply only to outside contributions to u-root. Maintainers
...
We, the u-root leadership, include this section to be transparent about the project's usage about
